                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="badge badge-success btn-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" title="edit" data-target="#editrole<?= $r['id']; ?>">Edit</a>
                                <a href="#" onclick="hapuSubmenu('<?= base_url('admin/hapusrole/')  . $r['id'] ?>')" class="badge badge-danger btn-sm tombol-hapus">Delete</a>
