                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="badge badge-success btn-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" title="edit" data-target="#exampleModalsubedit<?= $sm['id']; ?>">Edit</a>
                                <a href="#" onclick="hapuSubmenu('<?= base_url('menu/hapus/')  . $sm['id'] ?>')" class="badge badge-danger btn-sm tombol-hapus">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
