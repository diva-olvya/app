                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="#" class="badge badge-success btn-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" title="edit" data-target="#exampleModalmenuedit<?= $m['id']; ?>">Edit</a>
                                <a href="#" onclick="hapusMenu('<?= base_url('menu/hapusmenu/')  . $m['id'] ?>')" class="badge badge-danger btn-sm tombol-hapus">Delete</a>
...
<?php foreach ($menu as $m) : ?>
    ...
    <div class="modal fade" id="exampleModalmenuedit<?= $m['id']; ?>" tabindex="-1" aria-labelledby="exampleMenuModalLabelmenuedit" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleMenuModalLabelmenuedit">Edit new Menu</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
